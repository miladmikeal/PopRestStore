                ...
                <#list product.contentList as img>
                    ...
                    <#if img.productContentTypeEnumId == "PcntImageLarge">
                        ...
                        <img onClick="changeLargeImage('${img.productContentId}');"
                            ...
                            src="/moquicon/content/productImage/${img.productContentId}"
                            alt="Product Image">
                    </#if>
                </#list>
            </div>
...
<div class="modal fade" id="modal1">
    <div class="modal-dialog" role="document">
        <form class="modal-content" id="product-review-form" method="post" action="/moquicon/product/addReview">
            ...
            <div class="modal-body">
                <#if imgContent.productContentId??>
                    <img width="100%" height="200px" class="figure-img img-fluid product-img"
                        src="/moquicon/content/productImage/${imgContent.productContentId}" alt="Product Image">
                </#if>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    <#else>
        $productImageLarge.src = "/moquicon/assets/default.png";
    </#if>
